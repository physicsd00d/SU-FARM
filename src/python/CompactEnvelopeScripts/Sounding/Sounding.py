'''
#
This file creates an envelope for a Sounding Rocket launch
#
'''
...
vehicleName     = LaunchProviders.Sound
...
precomputedParamFile = 'Sonda3PayloadWsands_COARSENED.txt'                       # Points to file with precomputed profile for nominal trajectory
...
curMission['launchAzimuth'] = 278.    #degrees, this is what it looks like on Google Earth
