'''
#
This file creates an envelope for an Antares from MARS
#
'''
...
vehicleName     = LaunchProviders.Antares
launchLocation  = LaunchSites.MARS
...
curMission['launchAzimuth'] = 50.    #degrees, this is what it looks like on Google Earth
