...
plt.title('Conditional Probability of Failure for Falcon 9', fontsize=20)
# plt.show()
saveFolder = "/Users/marian/Downloads/ProbFail"
plt.savefig(saveFolder+'Falcon9.pdf', bbox_inches='tight')
...
# output = open('failProfile_conditionallySafe.py', 'w')
